						...
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<form>
							  ...
							  <div class="form-row">
								...
								<div class="form-group col-md-3">
								  <label for="itemDetailsCartoonPrice">Cartoon Price</label>
								  <input type="text" class="form-control" value="0" name="itemDetailsCartoonPrice" id="itemDetailsCartoonPrice">
								</div>
								<div class="form-group col-md-3">
							  ...
							  <div class="form-row">
								<div class="col-md-12">
								  <button type="button" id="addItem" class="btn btn-success btn-lg btn-block">
							  ...
							  <div class="form-row">
								<div class="col-md-4">
								  <button type="button" id="updateItemDetailsButton" class="btn btn-primary btn-block">
									<i class="fas fa-edit"></i> Update Item
								  </button>
								</div>
								<div class="col-md-4">
								  <button type="button" id="deleteItem" class="btn btn-danger btn-block">
									<i class="fas fa-trash"></i> Delete Item
								  </button>
								</div>
								<div class="col-md-4">
								  <button type="reset" class="btn btn-secondary btn-block" id="itemClear">
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
						...
						<div class="form-group col-md-6">
						  ...
						  <div class="input-group">
							...
							<div class="input-group-append">
							  <button class="btn btn-outline-secondary" type="button" id="searchItemBtn" data-toggle="modal" data-target="#itemSearchModal">
					  ...
					  <button type="button" id="generateReceiptBtn" class="btn btn-info" style="display: none;">Generate Receipt</button>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="itemSearchModalLabel">Search and Select Item</h5>
      ...
      <div class="modal-body">
        <div class="form-group">
          <input type="text" class="form-control" id="itemSearchInput" placeholder="Search items by name or number...">
        </div>
        <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
          <table class="table table-striped table-hover" id="itemSearchTable">
            <thead>
              <tr>
                <th>Item #</th>
                <th>Item Name</th>
...
<!-- Receipt Format Selection Modal -->
<div class="modal fade" id="receiptFormatModal" tabindex="-1" role="dialog" aria-labelledby="receiptFormatModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="receiptFormatModalLabel">Choose Receipt Format</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>Select how you want to generate the receipt:</p>
        <div class="row">
          <div class="col-md-6">
            <button type="button" class="btn btn-primary btn-block mb-2" onclick="generateReceiptFormat('print')">
              <i class="fas fa-print"></i> Print Receipt
            </button>
          </div>
          <div class="col-md-6">
            <button type="button" class="btn btn-success btn-block mb-2" onclick="generateReceiptFormat('pdf')">
        ...
        <div class="row">
          <div class="col-md-6">
            <button type="button" class="btn btn-info btn-block mb-2" onclick="generateReceiptFormat('doc')">
              <i class="fas fa-file-word"></i> Download Word (.doc)
            </button>
          </div>
          <div class="col-md-6">
            <button type="button" class="btn btn-secondary btn-block mb-2" onclick="generateReceiptFormat('txt')">
              <i class="fas fa-file-alt"></i> Download Text (.txt)
            </button>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <button type="button" class="btn btn-warning btn-block" onclick="generateReceiptFormat('csv')">
